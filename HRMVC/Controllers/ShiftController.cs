...
namespace HRMVC.Controllers
{
    public class ShiftController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            {
                using (var response = await httpClient.GetAsync(Baseurl + "api/atttables?flag=8"))
                {
        ...
        public async Task<IActionResult> GetByID(int id)
        {
            ...
            using (var httpClient = new HttpClient())
            {
                using (var response = await httpClient.GetAsync(Baseurl + "api/atttables/" + id + "?flag=8"))
                {
        ...
        public JsonResult Detail(int id)
        {
            ...
            using (var client = new HttpClient())
            {
                ...
                //HTTP GET
                var responseTask = client.GetAsync($"api/atttables/{id}?flag=8");
                responseTask.Wait();
        ...
        public async Task<IActionResult> Create(atttables att)
        {
            ...
            using (var httpClient = new HttpClient())
            {
                ...
                using (var response = await httpClient.PostAsync(Baseurl + "api/atttables?flag=8", content))
                {
        ...
        public ActionResult AddNew(atttables att)
        {
            using (var client = new HttpClient())
            {
                ...
                //HTTP POST
                var postTask = client.PostAsJsonAsync<atttables>("api/atttables?flag=8", att);
                postTask.Wait();
        ...
        public ActionResult Edit(atttables att)
        {
            using (var client = new HttpClient())
            {
                ...
                //HTTP POST
                var putTask = client.PutAsJsonAsync<atttables>($"api/atttables/{att.Id}?flag=8", att);
                putTask.Wait();
        ...
        public ActionResult Delete(int id)
        {
            using (var client = new HttpClient())
            {
                ...
                //HTTP DELETE
                var deleteTask = client.DeleteAsync($"api/atttables/{id}?flag=8");
                deleteTask.Wait();
